...
public class ex12 {
	public static void main(String[] args) {
		...
		double ir = salarioBruto * porcentual;
		double inss = salarioBruto * 0.10;
		double fgts = salarioBruto * 0.11;
		double descontosTotal = ir + inss;
		double salarioLiquido = salarioBruto - descontosTotal;
		
		System.out.println("o valor da hora é " + valorHora+" e as horas trabalhadas é " + horas +
				" salario bruto: " + valorHora + " * " + horas + " = " + salarioBruto);
		System.out.println("(-) IR "+ porcentual +"% : R$" + ir);
		System.out.println("(-) INSS ( 10%) : R$" + inss);
		System.out.println("FGTS (11%) : R$" + fgts);
		System.out.println("total de descontoi foi de R$:" +descontosTotal);
